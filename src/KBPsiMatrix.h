...
class KBPsiMatrix:public KBPsiMatrixInterface
{
    ...
    void computeKBpsi(Ions& ions, 
                      ...
                      const int first_color, const int nb_colors, 
                      const bool flag);
    void computeKBpsi(Ions& ions, 
...
public:
    ...
    void registerRemoteTasksDistMatrix(dist_matrix::RemoteTasksDistMatrix<DISTMATDTYPE>* remote_tasks_DistMatrix)
    {
    ...
    void computeHvnlMatrix(const Ions&,dist_matrix::SparseDistMatrix<DISTMATDTYPE>&)const;
    void computeHvnlMatrix(const Ions&,ProjectedMatricesInterface*)const;
    
    void computeHvnlMatrix(const KBPsiMatrixInterface* const,
                           const Ions&,
                           dist_matrix::SparseDistMatrix<DISTMATDTYPE>&)const;
    void computeHvnlMatrix(const KBPsiMatrixInterface* const,
                           const Ions&,
