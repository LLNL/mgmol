...
void ProjectedMatrices2N::assignBlocksH(dist_matrix::DistMatrix<DISTMATDTYPE>& h11, 
...
void ProjectedMatrices2N::iterativeUpdateDMwithEigenstates(const double occ_width,
                                                           const int nel,
                                                           ...
                                                           const bool flag_reduce_T)
{
    ...
    if( onpe0 )(*MPIdata::sout)<<"MVP target with mu = "<<mu<<" [Ry]"<<endl;
