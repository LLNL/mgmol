...
void dcopy(const int* const, const double* const, const int* const, 
           double*, const int* const);
void scopy(const int* const, const float* const, const int* const, 
...
void dswap(const int* const, double *, const int* const, 
                             double *, const int* const);
void sswap(const int* const, float *, const int* const, 
                             float *, const int* const);
...
inline void my_daxpy(const int n, const double alpha, const double* const a, 
                     double *b)
{
#if MY_VERSION   
    register int     i;
