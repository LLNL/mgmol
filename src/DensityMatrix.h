...
public:
    ...
    {
        return occ_uptodate_;
    }
    bool fromUniformOccupations() const
    {
       return uniform_occ_;
    }
    ...
    void build(const std::vector<DISTMATDTYPE>& occ, const int new_orbitals_index);
    void build(const dist_matrix::DistMatrix<DISTMATDTYPE>& z, const int new_orbitals_index);
