...
class PBEFunctional : public XCFunctional
{
    ...
    std::vector<POTDTYPE> vxc1_, vxc1_up_, vxc1_dn_, 
    ...
    void excpbe(const RHODTYPE rho, const RHODTYPE grad, 
        POTDTYPE *exc, POTDTYPE *vxc1, POTDTYPE *vxc2);
      
    void excpbe_sp(RHODTYPE rho_up, RHODTYPE rho_dn, 
        RHODTYPE grad_up, RHODTYPE grad_dn, RHODTYPE grad,  
        POTDTYPE *exc_up, POTDTYPE *exc_dn,
