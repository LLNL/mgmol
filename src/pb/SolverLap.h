...
// $Id: SolverLap.h,v 1.13 2010/01/28 22:56:47 jeanluc Exp $
#ifndef SOLVERLAP_H
#define SOLVERLAP_H
...
class SolverLap:public Solver<T2>{
...
public:
    ...
    SolverLap(T& oper, const short px, const short py, const short pz):
	     Solver<T2>(px,py,pz),
             oper_(oper)
    {
        nu1_=2; // default
