...
public:
    ...
    Laph6(const Grid& mygrid):Lap<T>(mygrid){
        ...
        assert(fabs((Lap<T>::inv_h2(0)-Lap<T>::inv_h2(1))/Lap<T>::inv_h2(0))<0.05);
        assert(fabs((Lap<T>::inv_h2(1)-Lap<T>::inv_h2(2))/Lap<T>::inv_h2(1))<0.05);
        assert(fabs((Lap<T>::inv_h2(2)-Lap<T>::inv_h2(0))/Lap<T>::inv_h2(2))<0.05);

        diagEl_   =(49./18.)*(Lap<T>::inv_h2(0)+Lap<T>::inv_h2(1)+Lap<T>::inv_h2(2));
    ...
    {
        setFDLowerOrderGrid(Laph4<T>::minNumberGhosts());
    }
