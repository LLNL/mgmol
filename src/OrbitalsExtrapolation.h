...
public:
    ...
    virtual bool extrapolatedH()const
    {
        return false;
    }
    ...
    virtual void setupPreviousOrbitals(LocGridOrbitals** orbitals,
        ...
        LocalizationRegions* lrs, ClusterOrbitals* local_cluster, MasksSet* currentMasks, MasksSet* corrtMasks, HDFrestart& h5f_file);
    
    virtual void extrapolate_orbitals(LocGridOrbitals** orbitals, LocGridOrbitals* new_orbitals)=0;
