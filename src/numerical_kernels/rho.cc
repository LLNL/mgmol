...
template<typename T1, typename T2, typename T3>
void nonOrthoRhoKernelDiagonalBlock(
    const short i0,
    const short ib,
    const int   x0,
    const int xb,
...
template 
void nonOrthoRhoKernel(const short i0,
    const short ib,
    const short j0,
    const short jb,
    const int x0,
    const int xb,
    const MATDTYPE* const mat,
    const int ld,
    const std::vector<const ORBDTYPE*>& psi,
    const double factor,
    RHODTYPE* const rho);
