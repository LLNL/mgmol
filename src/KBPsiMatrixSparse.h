...
class KBPsiMatrixSparse:public KBPsiMatrixInterface
{
    ...
    void computeHvnlMatrix(const KBPsiMatrixSparse* const kbpsi,
                           const Ion&,
    ...
    void getPsiKBPsiSym(const Ions& ions, 
                        VariableSizeMatrix<sparserow>& sm);
...
public:
    ...
    void computeHvnlMatrix(const KBPsiMatrixInterface* const kbpsi,
                           const Ions&,
                           dist_matrix::SparseDistMatrix<DISTMATDTYPE>&)const;
