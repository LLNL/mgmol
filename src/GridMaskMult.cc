...
template<typename T>
void GridMaskMult::applyPrivate(T *u, const unsigned short level,
...
template<typename T>
void GridMaskMult::applyPrivate(pb::GridFunc<T>& gu, const unsigned short level,
                        const unsigned short iloc)
{    
...
template
void GridMaskMult::applyPrivate(pb::GridFunc<double>& gu, const unsigned short level,
                               const unsigned short iloc);
template
void GridMaskMult::applyPrivate(pb::GridFunc<float>& gu, const unsigned short level,
                               const unsigned short iloc);
template
void GridMaskMult::applyPrivate(float *u, const unsigned short level,
                        const unsigned short iloc,
                        const bool first_application);
template
void GridMaskMult::applyPrivate(double *u, const unsigned short level,
                        const unsigned short iloc,
                        const bool first_application);
