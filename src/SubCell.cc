...
SubCell::SubCell(const pb::Grid& fine_grid, const short subdivx,
                 const short level):
    ...
    subdivx_(subdivx)
{
    ...
    outer_radius_ =
        sqrt( 0.25*( subcell_dimensions_[0]*subcell_dimensions_[0]
...
bool SubCell::spherePossibleOverlap(
    const Vector3D& center, const double radius, const short iloc,
