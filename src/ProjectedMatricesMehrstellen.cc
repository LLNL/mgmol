...
ProjectedMatricesMehrstellen::ProjectedMatricesMehrstellen(const int ndim, 
...
{
    if( dim_>0 ){
        delete matB_;matB_=0;
        delete invB_;invB_=0;
    }
}
...
void ProjectedMatricesMehrstellen::rotateAll(const dist_matrix::DistMatrix<DISTMATDTYPE>&  rotation_matrix,
