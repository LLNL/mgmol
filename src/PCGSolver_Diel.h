...
//        fully_periodic_=( (bc_[0]==1) && (bc_[1]==1) && (bc_[2]==1) );
    ...
    void preconSolve(pb::GridFunc<T2>& gf_v, const pb::GridFunc<T2>&  gf_f, const short level=0);
    
    bool solve(pb::GridFunc<T2>& gf_phi, pb::GridFunc<T2>& gf_rhs);

    bool solve(pb::GridFunc<T2>& gf_phi, pb::GridFunc<T2>& gf_rhs, pb::GridFunc<T2>& gf_rhod, pb::GridFunc<T2>& gf_vks);
