...
public:
    ...
    void computeVh(const Ions& ions, Rho& rho,
                   Potentials& pot);
    void computeVh(const pb::GridFunc<POTDTYPE>& vhinit,
                   const Ions& ions, Rho& rho,
                   Potentials& pot);
    ...
    double evhRhoc()const
    {
        return Evh_rhoc_;
    }
    double eEpsilon()const
    {
        return eepsilon_;
    }
};
