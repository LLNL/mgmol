...
#define D2FREE(p) { delete[] *p; delete[] p; }
...
#define D3FREE(p) { delete[] (**p); delete[] (*p); delete[](p); }
...
#define D4FREE(p) { delete[](***p); delete[](**p); delete[](*p); delete[](p); }
...
#define D5FREE(p) { delete[](****p); delete[](***p); delete[](**p); delete[](*p); delete[](p); }
