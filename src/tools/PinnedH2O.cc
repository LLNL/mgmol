...
double PinnedH2O::calculate_bondlength(const double atom1[3], const double atom2[3]) const
{
    return sqrt(pow(atom1[0] - atom2[0], 2) + pow(atom1[1] - atom2[1], 2) + pow(atom1[2] - atom2[2], 2));
}

double PinnedH2O::calculate_bondangle(const double atom1[3], const double atom2[3], const double atom3[3]) const
{
...
void PinnedH2O::rotation_matrix(const double axis[3], double angle, double matrix[3][3]) const
{
...
void PinnedH2O::cross(const double a[3], const double b[3], double result[3]) const
{
...
void PinnedH2O::apply_rotation(const double matrix[3][3], const double vec[3], double result[3]) const
{
...
void PinnedH2O::apply_transpose_rotation(const double matrix[3][3], const double vec[3], double result[3]) const
{
