...
Timer PoissonInterface::poisson_tm_("Poisson::poisson");

template <class T>
void Hartree<T>::solve(const pb::GridFunc<RHODTYPE>& rho, 
                       const pb::GridFunc<RHODTYPE>& rhoc)
{
    ...
    pb::GridFunc<POTDTYPE> bc_func(Poisson::grid_,Poisson::bc_[0], Poisson::bc_[1], Poisson::bc_[2]);
    if( dim_mpol>0 )
    {
        const Vector3D origin_cell(Poisson::grid_.origin(0),Poisson::grid_.origin(1),Poisson::grid_.origin(2));
        const Vector3D cell(Poisson::grid_.ll(0),Poisson::grid_.ll(1),Poisson::grid_.ll(2));
...
//    }
    ...
    if( onpe0 )
       (*MPIdata::sout)<<setprecision(2)<<scientific
           <<"Hartree: residual reduction = "<<residual_reduction
...
template class Hartree<pb::Laph2<POTDTYPE> >;
//template class Hartree<pb::Laph2<float> >;
template class Hartree<pb::Laph4<POTDTYPE> >;
//template class Hartree<pb::Laph4<float> >;
template class Hartree<pb::Laph6<POTDTYPE> >;
//template class Hartree<pb::Laph6<float> >;
template class Hartree<pb::Laph8<POTDTYPE> >;
//template class Hartree<pb::Laph8<float> >;
template class Hartree<pb::Laph4M<POTDTYPE> >;
//template class Hartree<pb::Laph4M<float> >;
template class Hartree<pb::Laph4MP<POTDTYPE> >;
//template class Hartree<pb::Laph4MP<float> >;
