...
private:
    ...
    void assignLocalPot(const std::vector<double>& x,
    ...
    void gauss_filter_kbp(const short, const short, const double, const bool printFlag);

    void assign_kbp(const short l, const short p,
...
public:
    ...
    short getMultiplicity(const short l)const
    {
        return multiplicity_[l];
    }
