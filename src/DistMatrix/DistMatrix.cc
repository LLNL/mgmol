...
extern "C"
{
#ifdef SCALAPACK
  // PBLAS
  void pdswap(Pint, double*, Pint, Pint, Pint, Pint,
                    double*, Pint, Pint, Pint, Pint);
  void psswap(Pint, float*, Pint, Pint, Pint, Pint,
                    float*, Pint, Pint, Pint, Pint);
  void pdsymm(Pchar, Pchar, Pint, Pint, Pdouble,
       Pdouble, Pint, Pint, Pint,
       Pdouble, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint);
  void pssymm(Pchar, Pchar, Pint, Pint, Pfloat,
       Pfloat, Pint, Pint, Pint,
       Pfloat, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint);
  void pdgemm(Pchar, Pchar, Pint, Pint, Pint, Pdouble,
       Pdouble, Pint, Pint, Pint,
       Pdouble, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint);
  void pdgemv(Pchar, Pint, Pint, Pdouble,
       Pdouble, Pint, Pint, Pint,
       Pdouble, Pint, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint, Pint);
  void pdsymv(Pchar, Pint, Pdouble,
       Pdouble, Pint, Pint, Pint,
       Pdouble, Pint, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint, Pint);       
  void psgemm(Pchar, Pchar, Pint, Pint, Pint, Pfloat,
       Pfloat, Pint, Pint, Pint,
       Pfloat, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint);
  void psgemv(Pchar, Pint, Pint, Pfloat,
       Pfloat, Pint, Pint, Pint,
       Pfloat, Pint, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint, Pint);
  void pssymv(Pchar, Pint, Pfloat,
       Pfloat, Pint, Pint, Pint,
       Pfloat, Pint, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint, Pint);
  void pdsyrk(Pchar, Pchar, Pint, Pint, 
       Pdouble, Pdouble, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint);
  void pssyrk(Pchar, Pchar, Pint, Pint, 
       Pfloat, Pfloat, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint);
  void pdtran(Pint, Pint, Pdouble,
       Pdouble, Pint, Pint, Pint,
       Pdouble, double* const, Pint, Pint, Pint);
  void pstran(Pint, Pint, Pfloat,
       Pfloat, Pint, Pint, Pint,
       Pfloat, float* const, Pint, Pint, Pint);
  void pdtrmm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pdouble, 
              Pdouble, Pint, Pint, Pint,
              double*, Pint, Pint, Pint);
  void pstrmm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pfloat, 
              Pfloat, Pint, Pint, Pint,
              float*, Pint, Pint, Pint);
  void pdtrsm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pdouble, 
              Pdouble, Pint, Pint, Pint,
              double*, Pint, Pint, Pint);
  void pstrsm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pfloat, 
              Pfloat, Pint, Pint, Pint,
              float*, Pint, Pint, Pint);              
  ...
  double pdlaset(char*,int*,int*,double*,double*,double*,int*,int*,int*);
  ...
  void pdgemr2d(Pint,Pint,Pdouble,Pint,Pint,Pint,
       double* const,Pint,Pint,Pint,Pint);
  void psgemr2d(Pint,Pint,Pfloat,Pint,Pint,Pint,
       float* const,Pint,Pint,Pint,Pint);
  void pigemr2d(Pint,Pint,Pint,Pint,Pint,Pint,
       int*,Pint,Pint,Pint,Pint);
  void pdpotrf(Pchar, int*, double*, int*, int*, int*, int*);
  void pspotrf(Pchar, int*, float*, int*, int*, int*, int*);
  void pdpotrs(Pchar, int*, int*, double*, int*, int*, int*, 
               double*, int*, int*, int*, int*);
  void pspotrs(Pchar, int*, int*, float*, int*, int*, int*, 
               float*, int*, int*, int*, int*);               
  void pdgetrf(int*, int*, double*, int*, int*, int*, int*, int*);
  void psgetrf(int*, int*, float*, int*, int*, int*, int*, int*);  
  void pdgetrs(Pchar, int*, int*, double*, int*, int*, int*, int*, 
               double*, int*, int*, int*, int*);
  void psgetrs(Pchar, int*, int*, float*, int*, int*, int*, int*, 
               float*, int*, int*, int*, int*);               
  ...
  void pdpocon(Pchar, int*, double*, int*, int*, int*, double*, double*,
             double*, int*, int*, int*, int*);
  void pspocon(Pchar, int*, float*, int*, int*, int*, float*, float*,
             float*, int*, int*, int*, int*);             
  ...
  void pdgesvd(Pchar, Pchar, int*, int*,
               double*, int*, int*, int*,
               double*, double*, int*, int*, int*, 
               double*, int*, int*, int*,
               double*, int*, int*);
  void psgesvd(Pchar, Pchar, int*, int*,
               float*, int*, int*, int*,
...
//  int idamax(Pint,double*,Pint);
  ...
  void dgemv(Pchar, Pint, Pint, Pdouble,
             Pdouble, Pint, Pdouble, Pint,
             Pdouble, double*, Pint);  

  void dsymv(Pchar, Pint, Pdouble,
             Pdouble, Pint, Pdouble, Pint,
             Pdouble, double*, Pint);

  // BLAS3
  void dsymm(Pchar, Pchar, Pint, Pint,
             Pdouble, Pdouble, Pint, Pdouble, Pint,
             Pdouble, double*, Pint);
  void dgemm(Pchar, Pchar, Pint, Pint, Pint,
             Pdouble, Pdouble, Pint, Pdouble, Pint,
             Pdouble, double*, Pint);
  void dsyrk(Pchar, Pchar, Pint, Pint,
             Pdouble, Pdouble, Pint, Pdouble, double* const, Pint);
  void dtrmm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pdouble, Pdouble, 
             Pint, double* const, Pint);
  void dtrsm(Pchar, Pchar, Pchar, Pchar, Pint, Pint, Pdouble, Pdouble, 
             Pint, double* const, Pint);
  // LAPACK
  double dlange(Pchar, int*, int*, double*, int*, double*);
  void dtrtrs(Pchar, Pchar, Pchar, Pint, Pint, Pdouble, Pint, 
              double*, Pint, int*);
  ...
  void dpocon(Pchar, int *, double *, int *, double *,
              double *, double *, int *, int *);
  void dsygst(int*, Pchar, int*, double*, int*, Pdouble, Pint, int*);
  void dsyev(Pchar, Pchar, int *, double *, int *, 
              double *, double *, int *, int *);
  void dgesvd(Pchar, Pchar, int *, int *, double *, int *, 
              double *, double *, int *, 
              double *, int *,
              double *, int *, int *);
}
...
template<class T> Timer DistMatrix<T>::matgather_tm_("DistMatrix::matgather");
template<class T> Timer DistMatrix<T>::pdgemr2d_tm_("DistMatrix::pdgemr2d");
template<class T> Timer DistMatrix<T>::potri_tm_("DistMatrix::potri");
template<class T> Timer DistMatrix<T>::potrf_tm_("DistMatrix::potrf");
template<class T> Timer DistMatrix<T>::trtri_tm_("DistMatrix::trtri");

template<class T> int DistMatrix<T>::distmatrix_def_block_size_ = 32;
template<class T> BlacsContext* DistMatrix<T>::default_bc_ = 0;
...
template <class T>
DistMatrix<T>::DistMatrix(const string& name, const BlacsContext& bc, 
              const int m, const int n) : object_name_(name),
                                          comm_global_(bc.comm_global()),
                                          bc_(bc)
{
...
DistMatrix<T>::DistMatrix(const string& name, const BlacsContext& bc, 
              ...
              const int mb, 
              const int nb) : object_name_(name),
                              comm_global_(bc.comm_global()),
                              bc_(bc)
{
  resize(m,n,mb,nb);
...
////////////////////////////////////////////////////////////////////////////////
template <class T>
DistMatrix<T>::DistMatrix(const DistMatrix<T>& a) : bc_(a.bc_),
   comm_global_(a.bc_.comm_global())
{
...
////////////////////////////////////////////////////////////////////////////////
template <class T>
void DistMatrix<T>::resize(const int m, const int n,
...
{
  if( active_ )
     memset(&val_[0],0,size_*sizeof(T));
}

////////////////////////////////////////////////////////////////////////////////
// Compute the global index of a distributed matrix entry pointed to by the local 
...
DistMatrix<double>& DistMatrix<double>::operator=(const DistMatrix<double>& src)
{
  ...
  //cout << " DistMatrix<double>::operator= for "<<object_name_<<" and "<<a.object_name_ << endl;
  ...
  else
  {
    ...
    int gictxt=bc.ictxt();
    pdgemr2d_tm_.start();
    pdgemr2d(&m_,&n_,src.val_,&ione,&ione,src.desc(),
                     &val_[0],&ione,&ione,desc_,&gictxt);
    pdgemr2d_tm_.stop();
  }
#endif
  return *this;
...
DistMatrix<float>& DistMatrix<float>::operator=(const DistMatrix<float>& src)
{
  ...
  //cout << " DistMatrix<float>::operator= for "<<object_name_<<" and "<<a.object_name_ << endl;
  if ( src.m() != m_ || src.n() != n_ )
  {
  ...
  else
  {
    ...
    int gictxt=bc.ictxt();
    pdgemr2d_tm_.start();
    psgemr2d(&m_,&n_,src.val_,&ione,&ione,src.desc(),
                     &val_[0],&ione,&ione,desc_,&gictxt);
    pdgemr2d_tm_.stop();
  }
#endif
...
TEMP_DECL
DistMatrix<double>& DistMatrix<double>::assign(const DistMatrix<double>& src,
                                               const int ib,
                                               const int jb)
{
  if ( this == &src ) return *this;
...
#ifdef SCALAPACK
  if ( src.bc_==bc_ && src.m_  == m_  && src.n_  == n_ 
                    && src.mb_ == mb_ && src.nb_ == nb_ )
#endif
  {
    // simple copy
    if ( active_ )
    {
      for(int j=0;j<n;j++){
          memcpy(&val_[(j+jb)*m_+ib], &src.val_[j*m], m*sizeof(double));
      }
    }
  }
#ifdef SCALAPACK
  else
  {
    ...
    assert( m+ib<= m_ );
    assert( n+jb<= n_ );
    pdgemr2d(&m, &n, src.val_, &ione, &ione, src.desc(),
                     val_,     &pib,  &pjb,  desc_,
                     &gictxt);
  }
#endif
...
TEMP_DECL
DistMatrix<float>& DistMatrix<float>::assign(const DistMatrix<float>& src,
                                               const int ib,
                                               const int jb)
{
  if ( this == &src ) return *this;
...
#endif
  {
    ...
    {
      for(int j=0;j<n;j++){
          memcpy(&val_[(j+jb)*m_+ib], &src.val_[j*m], m*sizeof(float));
      }
    }
  }
#ifdef SCALAPACK
  else
  {
    ...
    assert( m+ib<= m_ );
    assert( n+jb<= n_ );
    psgemr2d(&m, &n, src.val_, &ione, &ione, src.desc(),
                     val_,     &pib,  &pjb,  desc_,
                     &gictxt);
  }
#endif
      ...
      for (int li=0; li < mblocks_;li++)
      {
        for (int lj=0; lj < nblocks_;lj++)
        {
          for (int ii=0; ii < mbs(li); ii++)
          {
            ...
            {
              if ( i(li,ii) > j(lj,jj) )
                val_[ (ii+li*mb_)+(jj+lj*nb_)*mloc_ ] = xx;
            }
          }
        }
      }
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::gemv(const char transa,
...
#ifdef SCALAPACK
    int ione=1;
    pdgemv(&transa, &m, &n, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(), &ione,
         &beta, &val_[0], &ione, &ione, desc_, &ione);
#else
    int ione=1;
    dgemv(&transa, &m, &n, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &ione, &beta, &val_[0], &ione);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<float>::gemv(const char transa, 
                const float alpha, const DistMatrix<float>& a,
                const DistMatrix<float>& b, const float beta)
{
  assert( ictxt_ == a.ictxt() );
  assert( ictxt_ == b.ictxt() );
...
#ifdef SCALAPACK
    int ione=1;
    psgemv(&transa, &m, &n, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(), &ione,
         &beta, &val_[0], &ione, &ione, desc_, &ione);
#else
    int ione=1;
    sgemv(&transa, &m, &n, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &ione, &beta, &val_[0], &ione);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<double>::symv(const char uplo,
                const double alpha, const DistMatrix<double>& a,
                const DistMatrix<double>& b, const double beta)
{
  assert( ictxt_ == a.ictxt() );
...
#ifdef SCALAPACK
    int ione=1;
    pdsymv(&uplo, &m_, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(), &ione,
         &beta, &val_[0], &ione, &ione, desc_, &ione);
#else
    int ione=1;
    dsymv(&uplo, &m_, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &ione, &beta, &val_[0], &ione);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<float>::symv(const char uplo,
                const float alpha, const DistMatrix<float>& a,
                const DistMatrix<float>& b, const float beta)
{
  assert( ictxt_ == a.ictxt() );
...
#ifdef SCALAPACK
    int ione=1;
    pssymv(&uplo, &m_, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(), &ione,
         &beta, &val_[0], &ione, &ione, desc_, &ione);
#else
    int ione=1;
    ssymv(&uplo, &m_, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &ione, &beta, &val_[0], &ione);
#endif
  }
}
                ...
                const DistMatrix<double>& b, const double beta)
{
  ...
  if ( active_ )
  {
    ...
    pdgemm(&transa, &transb, &m, &n, &k, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(),
         &beta, &val_[0], &ione, &ione, desc_);
#else
...
#ifdef SCALAPACK
    int ione=1;
    psgemm(&transa, &transb, &m, &n, &k, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(),
         &beta, &val_[0], &ione, &ione, desc_);
#else
                ...
                const DistMatrix<double>& b, const double beta)
{
  ...
  if ( active_ )
  {
    ...
    pdsymm(&side, &uplo, &m_, &n_, &alpha,
         ...
         &beta, &val_[0], &ione, &ione, desc_);
#else
    dsymm(&side, &uplo, &m_, &n_, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &b.lld_, &beta, &val_[0], &lld_);
#endif
  }
}
...
#ifdef SCALAPACK
    int ione=1;
    pssymm(&side, &uplo, &m_, &n_, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &b.val_[0], &ione, &ione, b.desc(),
         &beta, &val_[0], &ione, &ione, desc_);
#else
    ssymm(&side, &uplo, &m_, &n_, &alpha, &a.val_[0], &a.lld_, 
          &b.val_[0], &b.lld_, &beta, &val_[0], &lld_);
#endif
  }
}
                              ...
                              const DistMatrix<double>& a)
{
  if ( active_ )
  {
    ...
    pdtrmm(&side, &uplo, &trans, &diag, &m_, &n_,
           &alpha, &a.val_[0], &ione, &ione, a.desc_,
           &val_[0], &ione, &ione, desc_);
#else
    dtrmm(&side, &uplo, &trans, &diag, 
          &m_, &n_, &alpha, &a.val_[0], &a.m_, &val_[0], &m_);
#endif
  }
}

TEMP_DECL
void DistMatrix<float>::trmm(const char side, const char uplo, 
                              const char trans, const char diag, 
                              const float alpha, 
                              const DistMatrix<float>& a)
{
  if ( active_ )
  {
    assert(a.m_==a.n_);
...
#ifdef SCALAPACK
    int ione=1;
    pstrmm(&side, &uplo, &trans, &diag, &m_, &n_,
           &alpha, &a.val_[0], &ione, &ione, a.desc_,
           &val_[0], &ione, &ione, desc_);
#else
    strmm(&side, &uplo, &trans, &diag, 
          &m_, &n_, &alpha, &a.val_[0], &a.m_, &val_[0], &m_);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<float>::trsm(const char side, const char uplo, 
                              const char trans, const char diag, 
                              const float alpha, const DistMatrix<float>& a)
{
  if ( active_ )
...
#ifdef SCALAPACK
    int ione=1;
    pstrsm(&side, &uplo, &trans, &diag, &m_, &n_,
           &alpha, &a.val_[0], &ione, &ione, a.desc_,
           &val_[0], &ione, &ione, desc_);
#else
...
#else
    dtrtrs(&uplo, &trans, &diag, &m_, &b.n_, &val_[0], &m_, 
           &b.val_[0], &b.m_, &info);
#endif
    if(info!=0)
    {
...
#ifdef SCALAPACK
    int ione=1;
    pstrtrs(&uplo, &trans, &diag, &m_, &b.n_, 
            &val_[0], &ione, &ione, desc_,
            &b.val_[0], &ione, &ione, b.desc_, &info);
#else
    strtrs(&uplo, &trans, &diag, &m_, &b.n_, &val_[0], &m_, 
           &b.val_[0], &b.m_, &info);
#endif
    if(info!=0)
    {
...
int DistMatrix<double>::potrf(char uplo)
{
  ...
  if ( active_ )
  {
    ...
    if(info!=0)
    {
      cerr << " DistMatrix::potrf, object "<<object_name_<<", info=" << info << endl;
    }
  }
...
void DistMatrix<double>::potrs(char uplo, DistMatrix<double>& b)
{
  ...
  if ( active_ )
  {
...
#ifdef SCALAPACK
    int ione=1;
    pdpotrs(&uplo, &m_, &b.n_, &val_[0], &ione, &ione, desc_,
            &b.val_[0], &ione, &ione, b.desc_, &info);
#else
    ...
    if(info!=0)
    {
      cerr << " DistMatrix::potrs, object "<<object_name_<<", info=" << info << endl;
#ifdef USE_MPI
      MPI_Abort(comm_global_, 2);
#else
      exit(2);
...
#ifdef SCALAPACK
    int ione=1;
    pspotrs(&uplo, &m_, &b.n_, &val_[0], &ione, &ione, desc_,
            &b.val_[0], &ione, &ione, b.desc_, &info);
#else
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::getrs(char trans, DistMatrix<double>& b, 
                               vector<int>& ipiv)
{
  int info;
  if ( active_ )
  {
    ...
    dgetrs(&trans, &m_, &b.n_, &val_[0], &m_, &ipiv[0], &b.val_[0], &b.m_, &info);
#endif
    if(info!=0)
    {
      cerr << " DistMatrix::getrs, object "<<object_name_<<", info=" << info << endl;
#ifdef USE_MPI
      MPI_Abort(comm_global_, 2);
#else
      exit(2);
...
TEMP_DECL
void DistMatrix<float>::getrs(char trans, DistMatrix<float>& b, 
                               vector<int>& ipiv)
{
  int info;
  if ( active_ )
...
#else
    assert( (int)ipiv.size()==m_ );
    sgetrs(&trans, &m_, &b.n_, &val_[0], &m_, &ipiv[0], &b.val_[0], &b.m_, &info);
#endif
    if(info!=0)
    {
      cerr << " DistMatrix::getrs, object "<<object_name_<<", info=" << info << endl;
...
int DistMatrix<double>::potri(char uplo)
{
  ...
  if ( active_ )
  {
    ...
    if(info!=0)
    {
      cerr << " DistMatrix::potri, object "<<object_name_<<", info=" << info << endl;
    }
  }
  potri_tm_.stop();
...
int DistMatrix<double>::trtri(char uplo, char diag)
{
  ...
  if ( active_ )
  {
    ...
    if(info!=0)
    {
      cerr << " DistMatrix::trtri, object "<<object_name_<<", info=" << info << endl;
    }
  }
  trtri_tm_.stop();
...
double DistMatrix<double>::norm(char ty)
{
  ...
  if ( active_ )
  {
    ...
    norm_val=pdlange(&ty, &m_, &n_, &val_[0], &ione, &ione, desc_, &work[0]);
#else
...
double DistMatrix<float>::norm(char ty)
{
  ...
  if ( active_ )
  {
    ...
    norm_val=(double)pslange(&ty, &m_, &n_, &val_[0], &ione, &ione, desc_, &work[0]);
#else
    if( ty=='I' || ty=='i' ) lwork=m_;
    vector<float> work(lwork);
...
double DistMatrix<double>::pocon(char uplo, double anorm)
{
  ...
  if ( active_ )
  {
    ...
    pdpocon(&uplo, &m_, &val_[0], &ione, &ione, desc_, 
...
double DistMatrix<float>::pocon(char uplo, float anorm)
{
  ...
  if ( active_ )
  {
    ...
    int*    iwork=new int[liwork];
    pspocon(&uplo, &m_, &val_[0], &ione, &ione, desc_, 
            &anorm, &rcond, work, &lwork, iwork, &liwork, &info);
    if(info!=0){
        cerr << "mloc_="<<mloc_<<", nloc_="<<nloc_<<endl;
        cerr << "npcol_="<<npcol_<<", nprow_="<<nprow_<<endl;
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::syrk(char uplo, char trans,
                double alpha, DistMatrix<double>& a, double beta)
{
  assert( ictxt_ == a.ictxt() );  
  ...
  if ( active_ )
  {
    ...
    pdsyrk(&uplo, &trans, &n, &k, &alpha,
         ...
         &beta, &val_[0], &ione, &ione, desc_);
#else
    dsyrk(&uplo, &trans, &n, &k, &alpha, &a.val_[0], &a.m_, 
          &beta, &val_[0], &m_);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<float>::syrk(char uplo, char trans,
                float alpha, DistMatrix<float>& a, float beta)
{
  assert( ictxt_ == a.ictxt() );  
  assert( n_ == m_ ); // *this must be a square matrix
...
#ifdef SCALAPACK
    int ione = 1;
    pssyrk(&uplo, &trans, &n, &k, &alpha,
         &a.val_[0], &ione, &ione, a.desc(),
         &beta, &val_[0], &ione, &ione, desc_);
#else
    ssyrk(&uplo, &trans, &n, &k, &alpha, &a.val_[0], &a.m_, 
          &beta, &val_[0], &m_);
#endif
  }
}
...
TEMP_DECL
void DistMatrix<double>::getsub(const DistMatrix<double>& a,
  int m, int n, int ia, int ja)
{
  ...
  int gictxt=bc.ictxt();
  //int gictxt = ictxt_;
  pdgemr2d(&m,&n,a.val_,&iap,&jap,a.desc_,
           val_,&ione,&ione,desc_,&gictxt);
#else
  for ( int j = 0; j < n; j++ )
    for ( int i = 0; i < m; i++ )
...
TEMP_DECL
void DistMatrix<float>::getsub(const DistMatrix<float>& a,
  int m, int n, int ia, int ja)
{
#ifdef SCALAPACK
  int iap=ia+1;
  ...
  int gictxt=bc.ictxt();
  //int gictxt = ictxt_;
  psgemr2d(&m,&n,a.val_,&iap,&jap,a.desc_,
           val_,&ione,&ione,desc_,&gictxt);
#else
  for ( int j = 0; j < n; j++ )
    for ( int i = 0; i < m; i++ )
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<int>::getsub(const DistMatrix<int> &a,
  int m, int n, int ia, int ja)
{
#ifdef SCALAPACK
  int iap=ia+1;
  ...
  BlacsContext bc( comm_global_ );
  int gictxt=bc.ictxt();
  pigemr2d(&m,&n,a.val_,&iap,&jap,a.desc(),
           val_,&ione,&ione,desc_,&gictxt);
#else
  for ( int j = 0; j < n; j++ )
    for ( int i = 0; i < m; i++ )
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::transpose(const double alpha,
     const DistMatrix<double>& a, const double beta)
{
  assert( ictxt_ == a.ictxt() );
...
TEMP_DECL
void DistMatrix<float>::transpose(const float alpha,
     const DistMatrix<float>& a, const float beta)
{
  assert( ictxt_ == a.ictxt() );
      ...
      for (int li=0; li < mblocks_;li++)
      {
        for (int lj=0; lj < nblocks_;lj++)
        {
          for (int ii=0; ii < mbs(li); ii++)
          {
            ...
            {
              if ( i(li,ii) < j(lj,jj) )
                val_[ (ii+li*mb_)+(jj+lj*nb_)*mloc_ ] = 0.0;
            }
          }
        }
      }
    ...
    for ( int li=0; li < mblocks_; li++ )
    {
      for ( int lj=0; lj < nblocks_; lj++ )
      {
        for ( int ii=0; ii < mbs(li); ii++ )
        {
          for ( int jj=0; jj < nbs(lj); jj++ )
          {
            tsum += (double)val_[ (ii+li*mb_)+(jj+lj*nb_)*mloc_ ]
                * (double)a.val_[ (ii+li*mb_)+(jj+lj*nb_)*mloc_ ];
          }
        }
      }
    }
...
void DistMatrix<double>::matgather(double* a, const int lda)const
{
  ...
  const int i=1;
  if ( active_ )
    pdlacp3( &m_, &i, &val_[0], desc_, a, &lda, &ii, &jj, &rev );
  ...
  for(int i=0;i<ns;i++){
    if( !active_ && mype>=(i+1)*n_active && mype<(i+2)*n_active ){
      ...
      mpirc=MPI_Recv(a, size, MPI_DOUBLE, rpe, 0, comm_global_, &status);
    }
    if( active_ && (mype+(i+1)*n_active)<nrpocs )
      mpirc=MPI_Send(a, size, MPI_DOUBLE, mype+(i+1)*n_active, 0, comm_global_);
...
void DistMatrix<float>::matgather(float* a, const int lda)const
{
  ...
  const int i=1;
  if ( active_ )
    pslacp3( &m_, &i, &val_[0], desc_, a, &lda, &ii, &jj, &rev );
  ...
  for(int i=0;i<ns;i++){
    ...
    if( active_ && (mype+(i+1)*n_active)<nrpocs )
      mpirc=MPI_Send(a, size, MPI_FLOAT, mype+(i+1)*n_active, 0, comm_global_);
    if(mpirc!=MPI_SUCCESS)
      cerr<<"DistMatrix<T>::matgather: MPI Send/Recv failed for PE "
          <<mype<<endl;
  }
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::sygst(int itype, char uplo, const DistMatrix<double>& b)
{
  int info;
  if ( active_ )
  {
    ...
    int ione=1;
    double  scale;
    pdsygst(&itype, &uplo, &m_, &val_[0], &ione, &ione, desc_, 
            &b.val_[0], &ione, &ione, b.desc_, &scale, &info);
#else
...
void DistMatrix<float>::sygst(int itype, char uplo, const DistMatrix<float>& b)
{
  ...
  if ( active_ )
  {
    ...
    int ione=1;
    float  scale;
    pssygst(&itype, &uplo, &m_, &val_[0], &ione, &ione, desc_, 
            &b.val_[0], &ione, &ione, b.desc_, &scale, &info);
#else
...
////////////////////////////////////////////////////////////////////////////////
TEMP_DECL
void DistMatrix<double>::syev(char jobz, char uplo, vector<double>& w,
                              DistMatrix<double>& z)
{
  int info;
  if ( active_ )
...
TEMP_DECL
void DistMatrix<float>::syev(char jobz, char uplo, vector<float>& w,
                              DistMatrix<float>& z)
{
  int info;
  if ( active_ )
                               ...
                               DistMatrix<double>& vt)
{
  ...
  if ( active_ )
  {
    ...
    pdgesvd(&jobu, &jobvt, &m_, &n_, &val_[0], &ione, &ione, desc_, &s[0], 
            &u.val_[0], &ione, &ione, u.desc_,
            &vt.val_[0], &ione, &ione, vt.desc_,
            &qwork[0], &lwork, &info);
    lwork=qwork[0];
    double* work=new double[lwork];
    pdgesvd(&jobu, &jobvt, &m_, &n_, &val_[0], &ione, &ione, desc_, &s[0], 
    ...
    int lwork=-1;
    double qwork[1];
    dgesvd(&jobu, &jobvt, &m_, &n_, &val_[0], &m_, &s[0],
           &u.val_[0], &m_,
           &vt.val_[0], &n_,
           qwork, &lwork, &info);
    lwork=qwork[0];
                               ...
                               DistMatrix<float>& vt)
{
  ...
  if ( active_ )
  {
    ...
    int lwork=-1;
    float qwork[1];
    sgesvd(&jobu, &jobvt, &m_, &n_, &val_[0], &m_, &s[0],
           &u.val_[0], &m_,
           &vt.val_[0], &n_,
           qwork, &lwork, &info);
    lwork=qwork[0];
...
int DistMatrix<double>::iamax(const int j, double& val)
{
    ...
    int proc_col=pc(j);
    int desc_col[9]={desc_[0],desc_[1],
                     desc_[2],1,
                     desc_[4],1,
                     desc_[6],proc_col,desc_[8]};
    
    if( mycol_==proc_col )
        pdamax(&m_, &val, &indx, &val_[y(j)*desc_[8]], &ix, &jx, desc_col, &incx);
    indx--; // fortran to C
...
int DistMatrix<float>::iamax(const int j, float& val)
{
    ...
    if( mycol_==proc_col )
        psamax(&m_, &val, &indx, &val_[y(j)*desc_[8]], &ix, &jx, desc_col, &incx);
    indx--; // fortran to C
...
void DistMatrix<double>::swapColumns(const int j1, const int j2)
{
    ...
    if ( active_ )
       pdswap(&m_,&val_[0], &ione, &jx, desc_, &inc,
                  &val_[0], &ione, &jy, desc_, &inc);
#else 
    int ione=1;  
...
void DistMatrix<float>::swapColumns(const int j1, const int j2)
{
    ...
    int inc=1; // indicates swap columns
    if ( active_ )
       psswap(&m_,&val_[0], &ione, &jx, desc_, &inc,
                  &val_[0], &ione, &jy, desc_, &inc);
#else 
    int ione=1;  
...
////////////////////////////////////////////////////////////////////////////////
template <class T>
void DistMatrix<T>::axpyColumn(const int icol, const double alpha, 
...
////////////////////////////////////////////////////////////////////////////////
template <class T>
void DistMatrix<T>::print(ostream& os, const int ia, const int ja,
...
template <class T>
const T DistMatrix<T>::getGlobalVal(const int i, const int j,
                     const bool onpe)const
{ 
  assert( i<m_ );
  assert( j<n_ );
  assert( i>=0 );
...
#ifdef USE_MPI
  MGmol_MPI& mmpi=*(MGmol_MPI::instance());
  if( !onpe )mmpi.bcast(&val, 1, 0);//MPI_Bcast(&val, 1, MPI_DOUBLE, 0, comm_global_);
#endif
  return val; 
}
...
template <class T>
void DistMatrix<T>::setGlobalVal(const int i, const int j, const T val,
                  const bool onpe)
{ 
  assert( i<m_ );
  assert( j<n_ );
...
template void DistMatrix<double>::resize(const int m, const int n,
                                         const int mb, const int nb);
template void DistMatrix<double>::init(const double* const a, const int lda);
template void DistMatrix<double>::trset(const char);
template void DistMatrix<double>::print(ostream&, const int, const int,
