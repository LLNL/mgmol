...
class BlacsContext
{
  ...
  public:
    ...
    bool operator==(const BlacsContext& bc) const 
    { return (this==&bc);}
    ...
    explicit BlacsContext(MPI_Comm comm, const char type, const int max_cpus=10000);
    ...
    explicit BlacsContext(MPI_Comm, const int ipe, const int nprow, const int npcol);
    ...
    BlacsContext(BlacsContext &bc, const int irow, const int icol, 
