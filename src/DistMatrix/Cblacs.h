...
void my_Cblacs_gridinfo(int, int *nprow, int *npcol, int *myprow, int *mypcol);
void my_Cblacs_gridinit(int *icontxt, char order[], int nprow, int npcol);
void my_Cblacs_gridmap(int *icontxt, int *pmap, int ldpmap, int nprow, int npcol);
...
void IGAMN2D(int*,CCHAR,CCHAR, int*, int*,int*,int*, int*, int*,int*,int*, int*);
